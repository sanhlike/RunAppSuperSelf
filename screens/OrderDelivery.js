        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <View style={{ flex: 1 }}>
                        <Text style={{ ...FONTS.body3 }}>Trường ĐH Công nghệ Thông tin</Text>
                    </View>
            ...
            >
                ...
                >
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <View style={{ flex: 1, marginLeft: SIZES.padding }}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                <Text style={{ ...FONTS.h4 }}>Lisa</Text>
                                <View style={{ flexDirection: 'row' }}>
                                    <Image
                                        source={icons.star}
                                        style={{ width: 18, height: 18, tintColor: COLORS.primary, marginRight: SIZES.padding }}
                                    />
                                    <Text style={{ ...FONTS.body3 }}>{isPedometerAvailable}</Text>
                                </View>
                            </View>

                            {/* Restaurant */}
                            <Text style={{ color: COLORS.darkgray, ...FONTS.body4 }}>Rapper Member BlackPink</Text>
                        </View>
                    </View>
                    ...
                    >
                        ...
                        >
                            <Text style={{ ...FONTS.h4, color: COLORS.white }}>{currentStepCount} Steps</Text>
                        </TouchableOpacity>
                        ...
                        >
                            <Text style={{ ...FONTS.h4, color: COLORS.white }}>Go Ranking</Text>
                        </TouchableOpacity>
                    </View>
